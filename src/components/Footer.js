    ...
    <div className="footer mt-auto py-3 es-footer">
      <Container>
        <Row className="justify-content-md-center">
          <Col md="3">
            <a href="https://github.com/ericaleesnyder" className='btn btn-primary' style={{width:"100%", marginBottom:"1rem"}} target="_blank" rel="noopener noreferrer"><Github></Github> GitHub</a>
          </Col>
          <Col md="3">
